...
export interface Settings {
  ...
  lastMainMode: 'practice' | 'exam'; volume: number; muted: boolean;
}
...
export interface SessionRecord {
  id: string; mode: Mode; key: KeyId; plannedQuestions: QuestionCount;
...
export interface SavedData { schemaVersion: 2; settings: Settings; sessions: SessionRecord[] }
